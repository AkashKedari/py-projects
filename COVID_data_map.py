...
data = pd.read_csv('C:\Akash\Python\COVID-19 Data\COVID-19-master\csse_covid_19_data\
csse_covid_19_time_series\time_series_covid19_confirmed_global.csv')
...
# Create a transpose of the dataframe , coloum corrosponds to country and row is for date
data_transposed  = data.T
## data_transposed.plot(y = ['Australia', 'China', 'US', 'Italy'], use_index = True, figsize = (8,8), marker = '*')


# Read in the world map shapefile
world = gpd.read_file(r'C:\Akash\PythonWorld_Map.shp')
